...
public class DeckController {
	...
	public String deleteDeck(Model model, @PathVariable Integer id) {
	    Deck deckExistente = deckRepo.findById(id).orElse(null);
	    if (deckExistente != null) {
	        for (Carta carta : deckExistente.getCartas()) {
	            carta.getDecks().remove(deckExistente);
	            carta.setDecks(null);
	            // Guardar las cartas modificadas en la base de datos
